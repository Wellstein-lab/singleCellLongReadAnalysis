...
#    docker run --rm -v $PWD:$PWD -w $PWD -it gsheynkmanlab/sqanti3 sqanti3_qc.py $file_ccsids_merge5collapsedgff  $gencode_primary_assembly_annotation $reference_genome --skipORF -o $name --fl_count $file_ccsids_merge5collapsedabundance --gtf -c 100
